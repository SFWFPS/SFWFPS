...
- Ceiling and floor textures + scanning logic.
...
- Plushie collectible system.
- Framerate & mobile optimizations.
- iOS updates + revert.
- Multiple file tweaks (index.html, README.md, CHANGELOG.md) and a rename.
...
**Status:** 199 commits in 8 days. All logic lives in one `index.html` file.
